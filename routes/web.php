...
Route::get('/', function () {
    return Auth::check()
        ? redirect()->to(request()->getSchemeAndHttpHost() . request()->getBasePath() . '/app/pages/dashboard.html?v=20260827')
...
Route::middleware(['auth', 'account.active'])->group(function () {
    ...
    Route::get('/dashboard', function () {
        return redirect()->to(request()->getSchemeAndHttpHost() . request()->getBasePath() . '/app/pages/dashboard.html?v=20260827');
    })->name('dashboard');
});
